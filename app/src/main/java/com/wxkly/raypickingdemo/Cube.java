...
public class Cube {
    ...
    public void rayPicking(int viewWidth, int viewHeight, float rx, float ry, float[] viewMatrix, float[] projMatrix) {
        ...
        for (int i = 0; i < convertedSquare.length / 9; i = i + 1) {
            Triangle triangle = new Triangle(new float[]{convertedSquare[9 * i], convertedSquare[9 * i + 1], convertedSquare[9 * i + 2]}, new float[]{convertedSquare[9 * i + 3], convertedSquare[9 * i + 4], convertedSquare[9 * i + 5]}, new float[]{convertedSquare[9 * i + 6], convertedSquare[9 * i + 7], convertedSquare[9 * i + 8]});
